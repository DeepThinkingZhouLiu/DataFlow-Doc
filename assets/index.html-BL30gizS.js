...
<span class="line"><span>cd run_dataflow</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="第三步-设置数据集" tabindex="-1"><a class="header-anchor" href="#第三步-设置数据集"><span>第三步: 设置数据集</span></a></h2><p>将合适大小的数据集(数据文件为json或jsonl格式)放到工作文件夹中</p><h2 id="第四步-初始化dataflow-pdf2model" tabindex="-1"><a class="header-anchor" href="#第四步-初始化dataflow-pdf2model"><span>第四步: 初始化dataflow-pdf2model</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-"><span class="line"><span>#初始化 </span></span>
...
<span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665;">├──</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D;"> sft_data_pipeline.py</span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD;">  # pipeline执行文件</span></span>
...
<span class="line"><span>├── sft_data_pipeline.py  # pipeline执行文件</span></span>
